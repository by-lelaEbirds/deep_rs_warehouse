...
O repositório está organizado para rastrear o fluxo de trabalho do Deep Research. A tabela abaixo detalha a autoria dos principais documentos gerados pelas IAs, conforme solicitado:
...
| `external_references/` | `external_references_1.md` | Lista de referências científicas (PubMed, Nature, etc.) com metadados. | **Não Especificada (Deep Research)** |
| `external_references/` | `external_references_2.txt` | Lista de referências científicas (PubMed, Nature, etc.) com metadados. | **Não Especificada (Deep Research)** |
